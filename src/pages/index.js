          ...
          <Row>
            ...
            <Col xs={11} xl={10} style={{
              ...
              <div>
                ...
                <Button type="dashed" danger size={'large'}><a href={'/categories/1'}>查看更多</a></Button>
              </div>
            </Col>
            <Col xs={2} xl={2} style={{
              backgroundColor: '#79D0F4',
          ...
          <Row>
            ...
            <Col xs={11} xl={10} style={{
              ...
              <div>
                ...
                <Button type="dashed" danger size={'large'}><a href={'/categories/2'}>查看更多</a></Button>
              </div>
            </Col>
            <Col xs={2} xl={2} style={{
              backgroundColor: 'rgb(51, 51, 51)',
          ...
          <Row>
            ...
            <Col xs={11} xl={10} style={{
              ...
              <div>
                ...
                <Button type="dashed" danger size={'large'}><a href={'/categories/3'}>查看更多</a></Button>
              </div>
            </Col>
            <Col xs={2} xl={2} style={{
              backgroundColor: '#79D0F4',
          ...
          <Row>
            ...
            <Col xs={11} xl={10} style={{
              ...
              <div>
                ...
                <Button type="dashed" danger size={'large'}><a href={'/categories/4'}>查看更多</a></Button>
              </div>
            </Col>
            <Col xs={2} xl={2} style={{
              backgroundColor: 'rgb(51, 51, 51)',
